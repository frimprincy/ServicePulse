...
class CommercialDetails extends Component{

    static navigationOptions = ({ navigation }) => ({
        title: `${navigation.state.params.Area.name}`,
   ...
   async  componentDidMount(){
      ...
      this.setState({
          deslongitude:subitem.geometry.location.lng,
          deslatitude:subitem.geometry.location.lat,
          desCoords:{
