...
componentDidMount(){
   ...
   const sec = new Date().getSeconds();
    ...
    submitHandler=()=>{
        if(this.state.fname=='' ||this.state.Lname=='' ||this.state.email=='' ||this.state.phone=='' || this.state.password=='' || this.state.destination==''){
            this.setState({
                error:"Please fill out all the inputText fields!",
                isError:true
        ...
        firebase.database().ref("Providers/").push({
            ...
            this.props.navigation.navigate('SignUpCont',{providerkey:snap.key})
            this.setState({
                isLoading:false
            })
               ...
               <ScrollView>
                <View style={styles.forms}>
                    ...
                    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                      <View>
                        <TextInput  style={[styles.textInput,!this.state.fnameValidate?styles.error:styles.success]} placeholder="First Name*"  underlineColorAndroid={'transparent'} onChangeText={(text)=>this.updateInputValue(text,'fname')}  />
                         <Text style={styles.ErrorInput}>{!this.state.fnameValidate?this.state.fnameError:null}</Text>
                        <TextInput  style={[styles.textInput,!this.state.lnameValidate?styles.error:styles.success]}  placeholder="Last Name*"  underlineColorAndroid={'transparent'} onChangeText={(text)=>this.updateInputValue(text,'lname')}  />
